...
The chooser was then compacted in response to user feedback. Its original pending-link badges and destination-status footer were removed; the dialog now focuses exclusively on the four channel options. The resulting true-mobile capture measures 499px high, preserving the same clear four-channel hierarchy with more open visual space below the modal.
