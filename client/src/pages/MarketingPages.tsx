...
const pricingPlans = [
  { name: "agents DX Platform", audience: "Launch and manage AI agents at scale—fast.", price: "USD 149", cadence: "/ Month", features: ["AI workforce for Support, Sales, and Booking", "Unlimited users", "Powerful automation tools", "Build, deploy, and run agents in one platform"], tag: "Core platform" },
